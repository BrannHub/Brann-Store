            ...
            <div class="wrap">
                ...
                <div class="recovery">
                    ...
                    <form class="recovery-form" action="" method="post">
                        <input type="text" class="input" name="Email" id="user_recover" placeholder="Correo Electrónico">
                        <input type="submit" class="btn btn-block btn-dark" name="recuperara" value="Recuperar contraseña">
                    </form>
                </div>
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                      <div class="tabs">
                        <h3 class="login-tab"><a style="text-decoration: none;" class="log-in active" href="#login-tab-content"><span>Ingreso<span></a></h3>
                        <!--
                      ...
                      <div class="tabs-content">
                        ...
                        <div id="login-tab-content" class="active">
                          <form class="login-form" action="" method="post">
                            <input style="color: #FFF; font-size: 1.2em;" type="text" name="username" class="input" id="user_login" autocomplete="off" placeholder="E-Mail o Usuario">
                            <input style="color: #FFF; font-size: 1.2em;" type="password" name="contrasena" class="input" id="user_pass" autocomplete="off" placeholder="Contraseña">
                            <input style="margin-top:-30px;" type="checkbox" class="checkbox" checked id="remember_me">
                            <label class="text-white" for="remember_me"><span style="color:#FFF;">Recordar en este equipo</span></label>
                            <br><br>
                            <input type="submit" class="btn btn-primary btn-block" name="ingresar" value="Iniciar Sesión">
                            <br><br>
                          </form>
                          <div class="help-action">
                            <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="#">Perdiste tu contraseña?</a></p>
                            <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="agree" href="#">Terminos de servicio</a></p>
                            <p><i class="fa fa-arrow-left"></i><a class="" href="registro.php">¿No tienes cuenta?</a></p>
                          </div>
                        </div>
                            <!-- TABS CONTENT SIGNUP
