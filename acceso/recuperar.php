...
if(isset($_GET['u']) && isset($_GET['key'])) {
  $rcon = $conexion->query("SELECT * FROM recuperar WHERE correo='".$_GET['u']."' AND clave='".$_GET['key']."'");
        ...
        <div class="login">
            <div class="wrap">
                ...
                <div class="content">
                    <!-- LOGO -->
                    <div class="logo">
                        <a href="#"><img src="https://i.imgur.com/jzdJ6KT.png" alt=""></a>
                    </div>
                    <br>
                    <p style="color:#FFF; float: right; margin-right: 5px;"><b>StockBrann v2.5 - <?php echo $nombreapp; ?></b></p>
                    <!-- SLIDESHOW -->
                    <div id="slideshow">
                        <div class="one">
                            <h2><span>GESTIONE</span></h2>
                            <p>Controle su negocio en una sola plataforma</p>
                        </div>
                        <div class="two">
                            <h2><span>A MEDIDA</span></h2>
                            <p>Configure y armamos tu sistema a medida</p>
                        </div>
                        <div class="three">
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                      <div class="tabs">
                        <h3 class="login-tab"><a style="text-decoration: none;" class="log-in active" href="#login-tab-content"><span>Recuperar<span></a></h3>
                        <!--
                      ...
                      <div class="tabs-content">
                        ...
                        <div id="login-tab-content" class="active">
                          <form class="login-form" action="" method="post">
                            <input style="color: #FFF; font-size: 1.2em;" type="password" name="contra" class="input" id="user_login" autocomplete="off" placeholder="Contraseña nueva">
                            <input style="color: #FFF; font-size: 1.2em;" type="password" name="contraa" class="input" id="user_pass" autocomplete="off" placeholder="Repite contraseña nueva">
                            <br><br>
                            <input type="submit" class="btn btn-danger btn-block" value="Cambiar contraseña">
                            <?php
                            if(isset($_POST['enviar'])) {
                              if($_POST['contra'] == $_POST['contraa']) {
                                $conexion->query("DELETE FROM recuperar WHERE correo='".$_GET['u']."' AND clave='".$_GET['key']."'");
                                $conexion->query("UPDATE usuarios SET contra='".$_POST['contra']."' WHERE correo='".$_GET['u']."'");
                                echo '<script type="text/javascript">swal("Contraseña restaurada", "redireccionando...", "success");</script>';
                                header("Refresh:2;URL=index.php");
                              } else {
                                echo '<script type="text/javascript">swal("Las contraseñas no son iguales", "No concuerdan intentalo otra vez.", "error");</script>';
                              }
                            }
                            ?>
                            <br><br>
